...
{
    public static int SumMinMax(Vector parm1)
    {
        int sum = 0;
    ...
    public static int DifMinMax(Vector parm1, Vector parm2)
    {
    ...
    public static int ElemCount(Vector parm1, Vector parm2)
    {
    ...
    public static Vector DelPositive(this Vector parm)
    {
        int newLength = 0;
        ...
        Vector newVector = new Vector(newLength);
